...
{
    public partial class PatientHms
    {
        ...
        public int? BipapRate { get; set; }
        public int? Indigent { get; set; }
        public int? UserId { get; set; }
        public int? PassagesPatientId { get; set; }
        ...
        public int? EmergencyOptout { get; set; }
        public int? GeoCoded { get; set; }
        public bool? Covid19 { get; set; }
        public string CovidDate { get; set; }
        public int? CovidUser { get; set; }
        public string CovidSession { get; set; }
    }
}
